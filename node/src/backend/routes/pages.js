    ...
    switch(req.method) {
        case 'GET':
            getDatabaseConnection(function(db) {
                // console.log(params);
                // console.log(ObjectId(params.id));
                var query = params && params.id ? { _id: ObjectId(params.id.toString()) } : {};
                ...
                var getPageItems = function(pageId, callback) {
                    ...
                    collection.find({
                        ...
                        // console.log('result in routes/pages :');
                        // console.log(result);
                        ...
                        result.forEach(function(value, index, arr) {
                            ...
                            // console.log('events in routes/pages : ' + events.length);
                        });
                ...
                collection.find({
                    ...
                    if(params.id && result.length > 0) {
                        getPageItems(params.id, function(comments, events) {
                            ...
                            // console.log('in routes/pages.js : (events) : ');
        ...
        case 'POST':
            ...
            form.parse(req, function(err, formData, files) {
                // console.log('formData from pages.js => ');
